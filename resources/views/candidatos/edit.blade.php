    ...
    <div class="d-grid pt-4 gap-4">
        ...
        <div class="pt-4 col-md-8 container justify-content-center align-items-center form_1">
            ...
            <div class="mb-3">
                ...
                <input id="nome" name="nome" type="text" class="form-control" tabindex="1" value="{{$candidato->nome}}">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input id="email" name="email" type="email" class="form-control" tabindex="1" value="{{$candidato->email}}">
            </div>
            <div class="mb-3">
                <label for="telefone" class="form-label">Telefone</label>
                <input id="telefone" name="telefone" type="text" class="form-control" tabindex="1" value="{{$candidato->telefone}}">
            </div>
        </div>
        <div class="pt-4 col-md-8 container justify-content-center align-items-center form_2" style="display: none;">
            ...
            <div class="mb-3">
                ...
                <input id="experiencias" name="experiencias" type="text" class="form-control" tabindex="1" value="{{$experiencia->descricao}}">
            </div>
            <div class="mb-3">
                <label for="formacoes" class="form-label">Formações Acadêmicas</label>
                <input id="formacoes" name="formacoes" type="text" class="form-control" tabindex="1" value="{{$formacao->descricao}}">
            </div>
        ...
        <div class="pt-4 col-md-8 container justify-content-center align-items-center form_3" style="display: none;">
            ...
            <div class="mb-3">
                ...
                <input id="usuario" name="usuario" type="text" class="form-control" tabindex="1" value="{{$candidato->usuario}}">
            </div>
            <div class="mb-3">
